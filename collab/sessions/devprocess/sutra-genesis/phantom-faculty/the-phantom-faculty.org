...
#+CAPTION: The Phantom Faculty assembled --- thirty-one cognitive modes arranged by domain. The physicists in the upper gallery, the measurers and biologists to the left, the mathematicians to the right, the information theorists and computational thinkers in the lower courts, and the meta-thinkers at the centre.
[[/images/writing/phantom-faculty/the-faculty-assembled.png]]
...
#+CAPTION: The Landau mode --- logical reconstruction. Each result derived from named premises, no equation without justification.
[[/images/writing/phantom-faculty/mode-landau.png]]
...
#+CAPTION: The Measurers --- three modes of empirical cognition. Faraday manipulates, Humboldt observes, Helmholtz unifies instrument and theory.
[[/images/writing/phantom-faculty/mode-measurers.png]]
...
Naturgemälde --- painting of nature./
#+end_quote
...
His /Naturgemälde/ is the first infographic: a cross-section of
...
#+CAPTION: The five mathematical modes --- from Gauss's patient computation to Thurston's embodied geometry. Each occupies a different relationship between the concrete and the abstract.
[[/images/writing/phantom-faculty/mode-mathematicians.png]]
