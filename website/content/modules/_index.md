...
Computational modules form the engine layer of MayaLucIA --- each a self-contained codebase with its own focus, but all sharing the same architectural principles: literate programming, functional composition, and understanding through creation.
